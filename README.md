...
Passionate about designing scalable cloud architectures, automating infrastructure, and building reliable DevOps workflows across **AWS** and **Google Cloud Platform (GCP)**.

## 🌩️ About Me

* ☁️ Designing and managing cloud-native solutions on AWS & GCP.
* 🚀 Automating infrastructure with Terraform and Infrastructure as Code (IaC).
